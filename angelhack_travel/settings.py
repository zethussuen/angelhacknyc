# Django settings for angelhack_travel project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'angelhack-travel.db',   # Or path to database file if using sqlite3.
...
SECRET_KEY = 'tzql*=vx5m#qij0egq*b9bradc_)syb15pf8bi-3v8-dfvcqjx'
...
ROOT_URLCONF = 'angelhack_travel.urls'
